...
# >< <> >< <> >< <> >< >< <> >< <> >< <> >< >< <> >< <>
  ...
  def start_game
    @finish = false
    puts " "
    puts "Welcome #{@name}! Is this a new game"
    puts "or are you continuing an old one?"
    puts " "
    ...
    while response == false
      ...
      if answer != "1" && answer != "2"
        puts "No! Enter a 1 or a 2....how bloody hard is that #{@name}?!"
      else 
        response = true
        if answer == "1"
...
# >< <> >< <> >< <> >< >< <> >< <> >< <> >< >< <> >< <>
  ...
  def continue_game
    ...
    @in_underline = @saved_output.gets
    @underline1 = @in_underline.split("")
    @underline1.delete("\n")
    @underline = @underline1.join
    @in_name = @saved_output.gets
    @name1 = @in_name.split("")
    @name1.delete("\n")
    @name = @name1.join
  end
